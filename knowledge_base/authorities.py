...
AUTHORITIES: dict[str, Authority] = {
    ...
    "local": Authority(
        key="local",
        name_he="רשויות מקומיות",
        name_en="Local authorities",
        source_type="official",
        priority=2,
        allowed_domains=("www.gov.il", "gov.il", "www.moin.gov.il", "moin.gov.il"),
        seed_urls=("https://www.gov.il/he/departments/local_government",),
        categories=("עירייה", "ארנונה", "רישוי", "שירותים עירוניים"),
        form_hints=(
            "רשות מקומית",
            "עירייה",
            "מועצה מקומית",
